...
DATA_INFO = {
    "cifar10": {
        ...
        "id": {
            "train": {
                "data_dir": "images_classic/",
                "imglist_path": "benchmark_imglist_custom/cifar10/train_cifar10.txt",
                
            },
            "val": {
                "data_dir": "images_classic/",
                "imglist_path": "benchmark_imglist_custom/cifar10/val_cifar10.txt",
            },
            "test": {
                "data_dir": "images_classic/",
                "imglist_path": "benchmark_imglist_custom/cifar10/test_cifar10.txt",
            },
        },
        "csid": {
            "datasets": ["cifar10c"],
            "cinic10": {
                "data_dir": "images_classic/",
                "imglist_path": "benchmark_imglist_custom/cifar10/val_cinic10.txt",
            },
            "cifar10c": {
                "data_dir": "images_classic/",
                "imglist_path": "benchmark_imglist_custom/cifar10/test_cifar10c.txt",
            },
        },
        "ood": {
            "val": {
                "data_dir": "images_classic/",
                "imglist_path": "benchmark_imglist_custom/cifar10/val_tin.txt",
            },
            "near": {
                "datasets": ["cifar100", "tin"],
                "cifar100": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar10/test_cifar100.txt",
                },
                "tin": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar10/test_tin.txt",
                },
            },
            "far": {
                "datasets": ["mnist", "svhn", "texture", "places365"],
                "mnist": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar10/test_mnist.txt",
                },
                "svhn": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar10/test_svhn.txt",
                },
                "texture": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar10/test_texture.txt",
                },
                "places365": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar10/test_places365.txt",
                },
            },
        },
    },
    "cifar100": {
        ...
        "id": {
            "train": {
                "data_dir": "images_classic/",
                "imglist_path": "benchmark_imglist_custom/cifar100/train_cifar100.txt",
            },
            "val": {
                "data_dir": "images_classic/",
                "imglist_path": "benchmark_imglist_custom/cifar100/val_cifar100.txt",
            },
            "test": {
                "data_dir": "images_classic/",
                "imglist_path": "benchmark_imglist_custom/cifar100/test_cifar100.txt",
            },
        },
        "csid": {
            "datasets": [],
        ...
        "ood": {
            "val": {
                "data_dir": "images_classic/",
                "imglist_path": "benchmark_imglist_custom/cifar100/val_tin.txt",
            },
            "near": {
                "datasets": ["cifar10", "tin"],
                "cifar10": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar100/test_cifar10.txt",
                },
                "tin": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar100/test_tin.txt",
                },
            },
            "far": {
                "datasets": ["mnist", "svhn", "texture", "places365"],
                "mnist": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar100/test_mnist.txt",
                },
                "svhn": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar100/test_svhn.txt",
                },
                "texture": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar100/test_texture.txt",
                },
                "places365": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/cifar100/test_places365.txt",
                },
            },
        },
    },
    "imagenet200": {
        ...
        "id": {
            "train": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist_custom/imagenet200/train_imagenet200.txt",
            },
            "val": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist_custom/imagenet200/val_imagenet200.txt",
            },
            "test": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist_custom/imagenet200/test_imagenet200.txt",
            },
        },
        "csid": {
            "datasets": ["imagenet_v2", "imagenet_c", "imagenet_r"],
            "imagenet_v2": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist_custom/imagenet200/test_imagenet200_v2.txt",
            },
            "imagenet_c": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist_custom/imagenet200/test_imagenet200_c.txt",
            },
            "imagenet_r": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist_custom/imagenet200/test_imagenet200_r.txt",
            },
        },
        "ood": {
            "val": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist_custom/imagenet200/val_openimage_o.txt",
            },
            "near": {
                "datasets": ["ssb_hard", "ninco"],
                "ssb_hard": {
                    "data_dir": "images_largescale/",
                    "imglist_path": "benchmark_imglist_custom/imagenet200/test_ssb_hard.txt",
                },
                "ninco": {
                    "data_dir": "images_largescale/",
                    "imglist_path": "benchmark_imglist_custom/imagenet200/test_ninco.txt",
                },
            },
            "far": {
                "datasets": ["inaturalist", "textures", "openimage_o"],
                "inaturalist": {
                    "data_dir": "images_largescale/",
                    "imglist_path": "benchmark_imglist_custom/imagenet200/test_inaturalist.txt",
                },
                "textures": {
                    "data_dir": "images_classic/",
                    "imglist_path": "benchmark_imglist_custom/imagenet200/test_textures.txt",
                },
                "openimage_o": {
                    "data_dir": "images_largescale/",
                    "imglist_path": "benchmark_imglist_custom/imagenet200/test_openimage_o.txt",
                },
            },
        },
    },
    "imagenet": {
        ...
        "failure": {
            ...
            "val1": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist_failure/val1_imagenet.txt",
            },
            "val2": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist_failure/val2_imagenet.txt",
            },
            "test": {
                "data_dir": "images_largescale/",
                "imglist_path": "benchmark_imglist_failure/test_imagenet.txt",
            },
        },
        "id": {
            "train": {
