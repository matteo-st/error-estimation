...
from synthetic_code.utils.models import BayesClassifier, MLPClassifier
...
def main():
    ...
    checkpoint_dir = os.path.join("checkpoints/ce", f"test_mlp_synth_dim-{dim}_classes-{n_classes}")
